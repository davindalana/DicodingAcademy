import AddPresenter from '../presenter/add-story-presenter';
        ...
        <form id="add-form" class="add-form">
            ...
            <div class="form-control">
                ...
                <div class="add-form__documentations__container">
                    <div class="add-form__documentations__buttons">
                        <button id="documentations-input-button" class="btn btn-outline" type="button" aria-label="Tombol Ambil Gambar untuk dokumentasi">
                            Ambil Gambar
                        </button>
                        ...
                        <button id="open-documentations-camera-button" class="btn btn-outline" type="button" aria-label="Buka kamera untuk dokumentasi">
                            Buka Kamera
                        </button>
                    </div>
                    <div id="camera-container" class="add-form__camera__container">
                        ...
                        <div class="add-form__camera__tools">
                            ...
                            <div class="add-form__camera__tools_buttons" >
                                <button id="camera-take-button" class="btn" type="button" aria-label="Tombol Ambil Gambar untuk dokumentasi">
                                    Ambil Gambar
                                </button>
                            </div>
                        </div>
            ...
            <div class="form-buttons">
                <span id="submit-button-container">
                    <button class="btn" type="submit" aria-label="Buat Story">Buat Story</button>
                </span>
...
`;
    ...
    #updateLatLngInput(lat, long) {
        console.log('Update input:', lat, long);
    ...
    async #populateTakenPictures() {
        const html = this.#takenDocumentations.reduce((accumulator, picture, currentIndex) => {
            ...
            <li class="add-form__documentations__outputs-item">
                <button type="button" data-deletepictureid="${picture.id}" class="add-form__documentations__outputs-item__delete-btn">
