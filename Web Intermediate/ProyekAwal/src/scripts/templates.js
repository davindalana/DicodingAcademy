...
export function generateReportItemTemplate({
  ...
  return `
    <div tabindex="0" class="report-item" data-reportid="${id}">
      <img class="report-item__image" src="${photoUrlImages[0]}" alt="${title}">
...
export function generateReportDetailTemplate({
  ...
  const imagesHtml = photoUrlImages.reduce(
    (accumulator, photoUrlImage) =>
      accumulator.concat(generateReportDetailImageTemplate(photoUrlImage, title)),
    '',
  );
  ...
  return `
    <div class="report-detail__header">
      ...
      <div class="report-detail__more-info">
        ...
        <div id="author" class="report-detail__author" data-value="${name}">Dilaporkan oleh:</div>
      </div>
